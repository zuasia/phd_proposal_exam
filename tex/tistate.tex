...
{
  \includegraphics[trim=20 0 0 20,clip,width=0.35\linewidth]{graphs/motivation1.pdf}
  \label{fig:motivation1}
}
\hspace{0.4in}
\subfloat[Temperature inversion's inflection voltage approaches nominal supply.] 
{
  \includegraphics[trim=10 40 40 20,clip,width=0.35\linewidth]{graphs/motivation2.pdf}
...
\subsubsection{Timing Margin Sensors: On-chip Power Supply Monitors (PSMs)}
...
\subsection{Temperature Inversion States (Ti-States)}
...
\centering
  ...
  \captionof{table}{PSM error compared to the reference setting for different $<temperature, voltage>$ configurations.}   
  \label{table:explore-err} 
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\textwidth}
	  \includegraphics[trim=0 -10 0 0,clip,width=0.95\linewidth]{graphs/explore-extrapolate.pdf}
...
\subsubsection{Scaling to FinFET and FD-SOI}
...
\begin{figure*}[t!]
  ...
  {
    \includegraphics[trim=0 0 40 0,clip,width=0.3\linewidth]{graphs/FFT-diff-factor.pdf}
    \label{fig:scale-FFT}
  }
  \endgroup
\hfill
  ...
  {
    \includegraphics[trim=0 0 40 0,clip,width=0.3\linewidth]{graphs/particlefilter-diff-factor.pdf}
...
\hfill
  ...
  {
    \includegraphics[trim=0 0 40 0,clip,width=0.3\linewidth]{graphs/Reduction-diff-factor.pdf}
